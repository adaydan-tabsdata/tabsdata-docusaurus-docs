...
# TableFrame API Guide
 ...
 This guide provides an in-depth exploration of the Tabsdata TableFrame API, extending the concepts introduced in [Working with Tables](table_frame#working-with-tables). The TableFrame is the core data structure in Tabsdata for representing and manipulating tabular data within Tabsdata functions.
...
## See Also
 ...
 - [Working with Tables](table_frame#working-with-tables) - Basic table operations and CLI commands
- [User-defined Functions (UDFs)](user_defined_functions#user-defined-functions) - Custom UDF implementation
