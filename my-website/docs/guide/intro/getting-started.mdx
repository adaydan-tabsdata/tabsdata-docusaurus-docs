...
:::note
The following tutorial is meant for CMD shell. You might need to adapt some commands if using PowerShell. You can use `bash` such as MinGW, CygWIn or Bash for Git, and follow the steps for Linux/macOS.
:::
...
:::warning
The virtual environment or alternative installation location must have **Python 3.12 or later**.
:::

:::tip[Optional and Recommended: Setup virtual environment]
...
## Log in and Create a Collection
...
2. To create a collection called tutorial, run the following command:
...
<CardGroup cols={2}>
  <Card title="Key Concepts" href="../guide/key-concepts">
    For a broader understanding of Tabsdata, see Key Concepts.
  </Card>
  <Card title="Publishers, Transformers & Subscribers">
    Learn more about defining publishers, transformers, and subscribers.
  </Card>
  <Card title="Transformers Deep Dive">
    Dive deeper into the processing that you can do with transformers.
  </Card>
  <Card title="Connector Plugins">
    Want to access an external system that does not have built-in support? You can build your own connector plugins.
  </Card>
  <Card title="Troubleshooting" href="../guide/troubleshooting">
