...
3. **Transaction Rollback Issues**: Remember that at the end of each transaction, the system is in a pristine state. If you need state to persist across function boundaries, ensure your transaction mode aligns with your data flow.
 ...
 For additional help, see [Troubleshooting](../troubleshooting#troubleshooting) or [Contact Us](../contact-support#contact-support).

    
## Related Topics

 - [Setting up Tabsdata over HTTPS](../security#security) - Security configuration and best practices
- [Secrets Management](../secrets-management#secrets-management) - Managing secrets with HashiCorp Vault
- [Tabsdata AI Agent (Tabby)](../ai-agent#ai-agent) - Detailed AI agent setup and usage
- [Getting Started](../getting-started#getting-started) - Initial server setup
