...
export const toc = [
  {value: '<span class="toc-kind-badge toc-kind-method">method</span>join()', id: 'tabsdata.TableFrame.join', level: 2},
];
...
<a class="entry-source-link" href="https://github.com/tabsdata/tabsdata/blob/b1.9/client/platform/src/main/python/tabsdata/tableframe/lazyframe/frame.py#L1083" target="_blank" rel="noopener noreferrer">View source ↗</a>
</div>
