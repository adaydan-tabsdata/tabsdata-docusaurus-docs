...
sidebarTitle: "TableFrame API Guide"
---
...
- Creating TableFrames - From a Dictionary
  - From Pandas
  - From Polars
  - Converting TableFrames
- Column Selection and Projection - Selecting Columns
  - Column Selectors
  - Adding and Modifying Columns
  - Dropping Columns
  - Renaming Columns
  - Column Aliasing
- Filtering Data - Basic Filtering
  - Combining Conditions
  - Range and Membership Checks
  - Limiting Results
  - Unique Values
- String Operations - Case Transformations
  - Pattern Matching
  - String Extraction and Replacement
  - String Manipulation
  - String Length and Position
  - Grok Parsing
- Numeric Operations - Arithmetic Operations
  - Rounding and Clipping
  - Mathematical Functions
  - Trigonometric Functions
  - Difference and Comparison
- Date and Time Operations - Extracting Components
  - Date Arithmetic
  - Truncation
  - Total Durations
  - Timezone Operations
  - Formatting
- Aggregation and Grouping - Basic Aggregations
  - Group By Operations
  - Shorthand Group Aggregations
  - Ranking
- Joining Tables - Join Types
  - Join on Multiple Columns
  - Handling Duplicate Column Names
  - Join Example
- Union Operations - Concatenation
- Data Manipulation - Handling Null Values
  - Handling NaN Values
  - Sorting
  - Type Casting
- TableFrame Attributes - Schema Information
  - Empty Checks
  - Query Explanation
- Literal Values
- Extracting Data - Extract as Columns
  - Extract as Rows
  - Unnesting
- Best Practices
- See Also
