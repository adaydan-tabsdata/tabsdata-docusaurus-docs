...
Table operations are covered in detail in the [API Reference documentation](https://docs.tabsdata.com/latest/ref/api/bycat-index.html).
...
Full list of Filters supported can be found in the [API Reference](https://docs.tabsdata.com/latest/ref/api/bycat-filters.html).
...
Full list of Aggregations supported can be found in the [API Reference](https://docs.tabsdata.com/latest/ref/api/bycat-aggregation.html).
