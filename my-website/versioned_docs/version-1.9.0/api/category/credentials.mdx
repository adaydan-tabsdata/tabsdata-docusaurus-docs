...
alias of [`S3AccessKeyCredentials`](/versions/1.9.0/api/module/tabsdata#tabsdata.S3AccessKeyCredentials)
...
alias of [`UserPasswordCredentials`](/versions/1.9.0/api/module/tabsdata#tabsdata.UserPasswordCredentials)
