...
1. If you are not logged in, use the following command to login to Tabsdata:
...
```bash
$ td fn register --collection tutorial --fn-path subscriber.py::sub --description "tutorial_subscriber"
```
