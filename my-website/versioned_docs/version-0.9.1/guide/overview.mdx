...
Tabsdata acts as a staging server between data storage systems. You interact with Tabsdata using Python and the command line interface (CLI).
...
A publisher function reads data from an external system and writes the data as one or more Tabsdata tables. For more information, see Working with Publishers.

**Transformers**

A transformer function applies transformations across one or more Tabsdata tables and writes the results as one or more Tabdata tables. Use transformers to prepare data for your data consumer teams. For more information, see Working with Transformers.

**Subscribers**

A subscriber function reads data from one or more tables in the Tabsdata server and writes them to an external system. For more information, see Working with Subscribers.
...
You can join the Tabsdata community here on [Github](https://www.github.com/tabsdata/tabsdata/) or [Discord](https://discord.gg/XRC5XZWppc).
