...
**Important**: The virtual environment or alternative installation location must have Python 3.12.
...
**3. Download the tutorial sample data,** [persons.csv](https://github.com/tabsdata/tabsdata/blob/main/client/td-sdk/tabsdata/examples/input/persons.csv), **from this location to the “input” folder in your working directory.**
