...
You can use this built-in Tabsdata publisher to read from a Db2 database.

## Example (Publisher - Db2)
...
@td.publisher(
    source=td.Db2Src(
        conn=Db2Conn(
            uri="db2://127.0.0.1:50000/sales_db",
...
The following code uses placeholder values for defining a publisher that reads data from a Db2 database and publishes it to Tabsdata tables:
...
@td.publisher(
    source=td.Db2Src(
        ...
        queries=["<db_query1>", "<db_query2>"],
        initial_values={
            "<variable_name1>": "<variable_value1>",
            "<variable_name2>": "<variable_value2>",
        },
    ),
    source=td.Db2Source(                        # Deprecated: use td.Db2Src instead (shown above).
        uri="db2://<path_to_db>",
