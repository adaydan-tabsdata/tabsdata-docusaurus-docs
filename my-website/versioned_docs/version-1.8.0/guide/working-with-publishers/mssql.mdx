...
- `<db_host>`: Name of your Microsoft SQL Server Database host.
- `<db_port>`: Port to connect to your Microsoft SQL Server Database.

##### Database

- `<database_name>`: Name of the database to connect to.
- TrustServerCertificate: Either of `<yes/no>` to be provided on whether to trust the server certificate.
