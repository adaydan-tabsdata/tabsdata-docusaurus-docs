...
| dlq_topic | str | Optional. A topic to send messages that fail deserialization (Dead Letter Queue). |
  ...
  **Rollover Strategies (Buffering)**
*You must define at least the time rollover strategy.*
...
To manually pause or resume the ingestion of data without deleting the publisher:
