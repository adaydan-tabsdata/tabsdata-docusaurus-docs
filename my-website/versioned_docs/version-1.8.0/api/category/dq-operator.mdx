...
Bases: [`BoolCriteria`](/versions/1.8.0/api/module/tabsdata-dataquality#tabsdata.dataquality.BoolCriteria)
...
Bases: [`CategoryCriteria`](/versions/1.8.0/api/module/tabsdata-dataquality#tabsdata.dataquality.CategoryCriteria)
...
Bases: [`Threshold`](/versions/1.8.0/api/module/tabsdata-dataquality#tabsdata.dataquality.Threshold)
