...
You can use this built-in Tabsdata publisher to read from a Postgres database.
...
# For rapid testing, you can assign the credential values directly. You can also use environment variables as detailed here: https://docs.tabsdata.com/latest/guide/secrets_management/env_variables/main.html.
...
## Setup (Publisher - Postgres)

The following code uses placeholder values for defining a publisher that reads data from a Postgres database and publishes it to Tabsdata tables:
