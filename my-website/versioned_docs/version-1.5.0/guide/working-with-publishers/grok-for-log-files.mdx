...
- **%\{IPV4:client_ip}** - Uses predefined IPV4 pattern, captures as “client_ip”
- **%\{WORD:method}** - Uses predefined WORD pattern, captures as “method”
- **%\{(?P`<custom_field>`[0-9]+)}** - Custom regex definition for numeric capture
