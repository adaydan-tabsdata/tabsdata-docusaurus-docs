...
Bases: [`BoolClassifier`](/versions/1.7.0/api/module/tabsdata-dataquality#tabsdata.dataquality.BoolClassifier)
...
Bases: [`Scale`](/versions/1.7.0/api/module/tabsdata-dataquality#tabsdata.dataquality.Scale)
...
Bases: [`Categorizer`](/versions/1.7.0/api/module/tabsdata-dataquality#tabsdata.dataquality.Categorizer)
