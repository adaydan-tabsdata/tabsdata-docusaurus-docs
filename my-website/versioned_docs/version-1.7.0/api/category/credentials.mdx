...
alias of [`S3AccessKeyCredentials`](/versions/1.7.0/api/module/tabsdata#tabsdata.S3AccessKeyCredentials)
...
alias of [`UserPasswordCredentials`](/versions/1.7.0/api/module/tabsdata#tabsdata.UserPasswordCredentials)
